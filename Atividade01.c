...
int main() { 
  ...
  const char* campeao = (distanciaGarrucha > distanciaSoberano && distanciaGarrucha > distanciaValente && distanciaGarrucha > distanciaChampanhe) ? "Garrucha"
     : ( distanciaSoberano > distanciaValente && distanciaSoberano > distanciaChampanhe ) ? "Soberano"
     : ( distanciaValente > distanciaChampanhe ) ? "Valente"
     : "Champanhe" ;
